...
const en: Dict = {
  ...
  "home.hero.subtitle": "PSS provides free IT training, accommodation, meals and full support to disadvantaged youth across Cambodia — opening the doors of the digital economy.",
  "home.mission.title": "Our Mission",
  "home.mission.body": "PSS is a local NGO registered with Cambodia's Ministry of Interior. We fight poverty by unlocking the potential of disadvantaged youth through access to high-quality digital education.",
  ...
  "home.context.s4.label": "STEM enrollment — men are 2.5× more likely than women to choose STEM",
  "home.context.s4.source": "MoEYS",
  "home.legacy.title": "A 20-Year Legacy",
  "home.legacy.body": "PSS is the local partner originating from Passerelles Numériques Cambodia (PNC), active since 2005. Two decades of proven impact in transforming lives through technology.",
  "home.support.title": "Full Support, From Day One",
  "home.support.body": "Every PSS student receives complete support — because real opportunity requires more than tuition.",
  ...
  "about.vision.body": "A Cambodia where all youth have access to quality education and opportunities to fulfill their potential in the digital economy.",
  "about.mission.title": "Our Mission",
  "about.mission.body": "To provide high-quality IT training, professional skills, and employment support to underprivileged Cambodian youth.",
  "about.values.title": "Core Values",
  "about.values.trust": "Trust",
  "about.values.trust.body": "We honor every commitment we make to students, partners and donors.",
  "about.values.responsibility": "Responsibility",
  "about.values.responsibility.body": "We act with accountability and stewardship over every resource entrusted to us.",
  "about.values.solidarity": "Solidarity",
  "about.values.solidarity.body": "We stand together — across cultures, backgrounds and generations — to lift each other up.",
  "about.values.respect": "Respect",
  "about.values.respect.body": "We treat every individual with dignity, listening with empathy and openness.",
  ...
  "programs.it.body": "Our flagship program — combining technical excellence with life skills and professional preparation.",
  ...
  "programs.selection.body": "A rigorous 4-step process from January to October across Cambodia, in partnership with local organisations. We target 75–100 students each cohort, with at least 50% female to bridge the tech gender gap.",
  ...
  "programs.support.body": "PSS provides accommodation, food, training, health costs and a monthly allowance — so students can focus entirely on their future.",
  ...
  "impact.story.body": "PSS graduates are now software engineers, cloud administrators and team leaders across Cambodia and beyond — proving that opportunity, not background, defines a future.",

  // Get Involved
  "involved.title": "Get Involved",
  "involved.subtitle": "Help us change a life today",
  "involved.donate.title": "Donate via KHQR",
  "involved.donate.body": "Scan the KHQR code with any Cambodian banking app to support Promoting Skill for Success Organisation. Every contribution funds tuition, meals, accommodation and laptops.",
  ...
  "involved.partner.body": "Partner with PSS to recruit talent, sponsor a cohort, or invest in Cambodia's digital future. Our partners gain direct access to highly trained, work-ready IT graduates.",
...
const km: Dict = {
  ...
  "home.hero.subtitle": "PSS ផ្តល់នូវការបណ្តុះបណ្តាល IT ដោយឥតគិតថ្លៃ កន្លែងស្នាក់នៅ អាហារ និងការគាំទ្រពេញលេញដល់យុវជនក្រីក្រនៅទូទាំងប្រទេសកម្ពុជា — បើកទ្វារនៃសេដ្ឋកិច្ចឌីជីថល។",
  "home.mission.title": "បេសកកម្មរបស់យើង",
  "home.mission.body": "PSS គឺជាអង្គការក្រៅរដ្ឋាភិបាលក្នុងស្រុកដែលបានចុះបញ្ជីជាមួយក្រសួងមហាផ្ទៃនៃប្រទេសកម្ពុជា។ យើងប្រយុទ្ធប្រឆាំងនឹងភាពក្រីក្រដោយដោះសោសក្តានុពលរបស់យុវជនក្រីក្រតាមរយៈការអប់រំឌីជីថលដែលមានគុណភាពខ្ពស់។",
  ...
  "home.legacy.body": "PSS គឺជាដៃគូក្នុងស្រុកដែលមានដើមកំណើតពី Passerelles Numériques Cambodia (PNC) ដែលដំណើរការតាំងពីឆ្នាំ ២០០៥។",
  "home.support.title": "ការគាំទ្រពេញលេញ ចាប់ពីថ្ងៃដំបូង",
  "home.support.body": "សិស្ស PSS គ្រប់រូបទទួលបានការគាំទ្រពេញលេញ — ព្រោះឱកាសពិតប្រាកដត្រូវការច្រើនជាងថ្លៃសិក្សា។",
  ...
  "about.vision.body": "កម្ពុជាដែលយុវជនទាំងអស់មានឱកាសចូលរៀនអប់រំដែលមានគុណភាព និងបំពេញសក្តានុពលរបស់ខ្លួននៅក្នុងសេដ្ឋកិច្ចឌីជីថល។",
  "about.mission.title": "បេសកកម្មរបស់យើង",
  "about.mission.body": "ផ្តល់ការបណ្តុះបណ្តាល IT ប្រកបដោយគុណភាពខ្ពស់ ជំនាញវិជ្ជាជីវៈ និងការគាំទ្រការងារដល់យុវជនកម្ពុជាក្រីក្រ។",
  "about.values.title": "តម្លៃស្នូល",
  "about.values.trust": "ទំនុកចិត្ត",
  "about.values.trust.body": "យើងគោរពរាល់ការប្តេជ្ញាចិត្តដែលយើងធ្វើជាមួយសិស្ស ដៃគូ និងម្ចាស់ជំនួយ។",
  ...
  "about.timeline.2009": "កម្មវិធីគ្រប់គ្រងទិន្នន័យ — បណ្តុះបណ្តាលនិស្សិតបញ្ចប់ការសិក្សាជាង ៤០០ នាក់",
  ...
  "programs.it.body": "កម្មវិធីរបស់យើង — រួមបញ្ចូលជំនាញបច្ចេកទេសជាមួយជំនាញជីវិត និងការត្រៀមលក្ខណៈវិជ្ជាជីវៈ។",
  ...
  "programs.selection.body": "ដំណើរការ ៤ ជំហានដ៏តឹងរ៉ឹងពីខែមករាដល់ខែតុលា ដោយសហការជាមួយដៃគូក្នុងស្រុក។",
  ...
  "programs.support.body": "PSS ផ្តល់នូវកន្លែងស្នាក់នៅ អាហារ ការបណ្តុះបណ្តាល ការថែទាំសុខភាព និងប្រាក់ឧបត្ថម្ភប្រចាំខែ។",
  ...
  "impact.story.body": "និស្សិតបញ្ចប់ការសិក្សា PSS ឥឡូវនេះគឺជាវិស្វករកម្មវិធី អ្នកគ្រប់គ្រង Cloud និងអ្នកដឹកនាំក្រុមនៅទូទាំងប្រទេសកម្ពុជា និងលើសពីនេះ។",

  "involved.title": "ចូលរួម",
  "involved.subtitle": "ជួយយើងផ្លាស់ប្តូរជីវិតមួយថ្ងៃនេះ",
  "involved.donate.title": "បរិច្ចាគតាម KHQR",
  "involved.donate.body": "ស្កេន KHQR ជាមួយកម្មវិធីធនាគារកម្ពុជាណាមួយ ដើម្បីគាំទ្រអង្គការ Promoting Skill for Success។",
  ...
  "involved.partner.body": "ភ្ជាប់ដៃជាមួយ PSS ដើម្បីជ្រើសរើសទេពកោសល្យ ឧបត្ថម្ភមួយជំនាន់ ឬវិនិយោគលើអនាគតឌីជីថលរបស់កម្ពុជា។",
...
const fr: Dict = {
  ...
  "home.hero.subtitle": "PSS offre une formation IT gratuite, l'hébergement, les repas et un accompagnement complet aux jeunes défavorisés du Cambodge — ouvrant les portes de l'économie numérique.",
  "home.mission.title": "Notre mission",
  "home.mission.body": "PSS est une ONG locale enregistrée auprès du Ministère de l'Intérieur du Cambodge. Nous luttons contre la pauvreté en libérant le potentiel des jeunes défavorisés grâce à l'éducation numérique de qualité.",
  ...
  "home.context.s3.source": "MoEYS 23-24",
  "home.context.s4.value": "31,2 %",
  "home.context.s4.label": "inscrits en STEM — les hommes sont 2,5× plus susceptibles que les femmes de choisir les STEM",
  "home.context.s4.source": "MoEYS",
  "home.legacy.title": "20 ans d'héritage",
  "home.legacy.body": "PSS est le partenaire local issu de Passerelles Numériques Cambodge (PNC), actif depuis 2005. Deux décennies d'impact prouvé.",
  "home.support.title": "Un accompagnement complet, dès le premier jour",
  "home.support.body": "Chaque étudiant PSS bénéficie d'un soutien complet — car la véritable opportunité dépasse les frais de scolarité.",
  ...
  "about.vision.body": "Un Cambodge où tous les jeunes ont accès à une éducation de qualité et à des opportunités pour réaliser leur potentiel dans l'économie numérique.",
  "about.mission.title": "Notre mission",
  "about.mission.body": "Fournir une formation IT de haute qualité, des compétences professionnelles et un soutien à l'emploi aux jeunes Cambodgiens défavorisés.",
  "about.values.title": "Valeurs fondamentales",
  "about.values.trust": "Confiance",
  "about.values.trust.body": "Nous honorons chaque engagement pris envers les étudiants, partenaires et donateurs.",
  "about.values.responsibility": "Responsabilité",
  "about.values.responsibility.body": "Nous agissons avec responsabilité sur chaque ressource qui nous est confiée.",
  "about.values.solidarity": "Solidarité",
  "about.values.solidarity.body": "Nous nous unissons — à travers les cultures, milieux et générations.",
  "about.values.respect": "Respect",
  "about.values.respect.body": "Nous traitons chaque individu avec dignité, écoute et ouverture.",
  ...
  "programs.it.body": "Notre programme phare — alliant excellence technique, compétences de vie et préparation professionnelle.",
  ...
  "programs.selection.body": "Un processus rigoureux en 4 étapes de janvier à octobre à travers le Cambodge, en partenariat avec des organisations locales. Nous visons 75–100 étudiants par promotion, avec au moins 50 % de femmes.",
  ...
  "programs.support.body": "PSS fournit hébergement, nourriture, formation, frais de santé et une allocation mensuelle.",
  ...
  "impact.story.body": "Les diplômés PSS sont aujourd'hui ingénieurs logiciels, administrateurs cloud et chefs d'équipe à travers le Cambodge.",
  ...
  "involved.donate.body": "Scannez le code KHQR avec n'importe quelle application bancaire cambodgienne pour soutenir Promoting Skill for Success Organisation.",
  ...
  "involved.partner.body": "Associez-vous à PSS pour recruter des talents, parrainer une promotion ou investir dans l'avenir numérique du Cambodge.",
  ...
  "footer.tagline": "Donner aux jeunes Cambodgiens les moyens de réussir grâce à l'éducation numérique.",
...
export const dictionaries: Record<Lang, Dict> = { en, km, fr };
